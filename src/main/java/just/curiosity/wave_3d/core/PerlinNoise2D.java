...
public final class PerlinNoise2D {
  ...
  private static final List<double[]> gradientVectors;
  ...
  static {
    ...
    gradientVectors = new ArrayList<>();
    gradientVectors.add(new double[]{gradientRange, 0D});
    gradientVectors.add(new double[]{0D, gradientRange});
    gradientVectors.add(new double[]{-gradientRange, 0D});
    gradientVectors.add(new double[]{0D, -gradientRange});
  ...
  public static void rotateGradientVectors() {
    Collections.rotate(gradientVectors, 1);
  }
  ...
  private static double[] gradientVector(int x, int y) {
    ...
    return gradientVectors.get(aux & (gradientVectors.size() - 1));
  }
